...
// ContentCard Skeleton - for carousel and grid items
...
// Default export for backward compatibility (ContentCard Skeleton)
export function Skeleton() {
  return <ContentCardSkeleton />;
}

// Backward compatibility export
export const MovieCardSkeleton = ContentCardSkeleton;
