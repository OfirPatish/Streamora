...
import { SearchResultSkeleton } from "@/components/ui/skeletons/Skeleton";
                  ...
                  <div className="flex items-start gap-2 mb-2">
                    <h3 className="font-semibold text-foreground group-hover:text-foreground/80 truncate">
                      {result.title}
                                         ...
                                         <Badge className={`${getTypeColor(result.type)} text-primary-foreground text-xs flex items-center gap-1`}>
                      {getTypeIcon(result.type)}
                      {result.type}
                    </Badge>
                  </div>
