...
import { ContentCarousel } from "@/components/sections/shared";
import {
  useNowPlayingMovies,
  useTopRatedMovies,
  useOnTheAirSeries,
  useTopRatedSeries,
} from "@/hooks/api/useHomeQueries";
...
export function HomeContent() {
  ...
  const { data: topRatedMovies, isLoading: loadingTopRatedMovies, error: errorTopRatedMovies } = useTopRatedMovies();
  const { data: onTheAirSeries, isLoading: loadingOnTheAirSeries, error: errorOnTheAirSeries } = useOnTheAirSeries();
  const { data: topRatedSeries, isLoading: loadingTopRatedSeries, error: errorTopRatedSeries } = useTopRatedSeries();
    ...
    <section className="w-full py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
      <div className="space-y-8 sm:space-y-10">
        ...
        <ContentCarousel
          ...
          error={errorNowPlayingMovies?.message}
        />
        ...
        <ContentCarousel
          ...
          error={errorOnTheAirSeries?.message}
        />
        ...
        <ContentCarousel
          ...
          error={errorTopRatedSeries?.message}
        />
      </div>
    </section>
  );
