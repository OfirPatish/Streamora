...
import { usePopularMovies, useTopRatedMovies, usePopularSeries, useTopRatedSeries, Movie, Series } from "./index";
import { FeaturedContent } from "@/components/sections/hero/types";
